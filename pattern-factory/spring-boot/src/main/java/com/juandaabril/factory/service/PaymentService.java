  ...
  public void pay(
    ...
    if (method.equals("credit card")) {
      ...
      CreditCardResponse creditCardResponse =
          restTemplate.postForEntity(CREDIT_CARD_API, request, CreditCardResponse.class).getBody();
      ...
      PaypalTokenResponse tokenResponse =
          restTemplate
      ...
      BankResponse bankResponse =
          restTemplate.postForEntity(CREDIT_BANK_API, bankRequest, BankResponse.class).getBody();
    ...
    Payment payment =
        new Payment(null, method, amount, providerId, LocalDate.now(), LocalTime.now());
